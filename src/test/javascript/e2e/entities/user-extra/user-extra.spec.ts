...
describe('UserExtra e2e test', () => {
  ...
  it('should load UserExtras', async () => {
    ...
    expect(await userExtraComponentsPage.getTitle()).to.eq('condominiumApp.userExtra.home.title');
  });
  ...
  it('should load create UserExtra page', async () => {
    ...
    expect(await userExtraUpdatePage.getPageTitle()).to.eq('condominiumApp.userExtra.home.createOrEditLabel');
  ...
  it('should create and save UserExtras', async () => {
    ...
    await userExtraComponentsPage.clickOnCreateButton();
    await promise.all([userExtraUpdatePage.setPhoneInput('phone'), userExtraUpdatePage.userSelectLastOption()]);
    expect(await userExtraUpdatePage.getPhoneInput()).to.eq('phone', 'Expected Phone value to be equals to phone');
  ...
  it('should delete last UserExtra', async () => {
    ...
    expect(await userExtraDeleteDialog.getDialogTitle()).to.eq('condominiumApp.userExtra.delete.question');
